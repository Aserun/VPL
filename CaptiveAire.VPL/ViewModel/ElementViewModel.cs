...
{
    public abstract class ElementViewModel : ViewModelBase, IElement
    {
        private readonly ParametersViewModel _parameters = new ParametersViewModel();
        private readonly IElementOwner _owner;
        private readonly Guid _elementTypeId;
        private Point _location;
        private Point _startLocation;
        private bool _isDragging;
        private readonly IBlocks _blocks = new BlocksViewModel();
        ...
        protected ElementViewModel(IElementOwner owner, Guid elementTypeId)
        {
