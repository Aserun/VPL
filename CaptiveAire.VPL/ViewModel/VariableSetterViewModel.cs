...
{
    public class VariableSetterViewModel : StatementViewModel, IVariableReference
    {
        private readonly IVariable _variable;
        private readonly ParameterViewModel _parameter;

        public VariableSetterViewModel(IElementOwner owner, Guid variableId) 
        ...
        public VariableSetterViewModel(IElementCreationContext context) 
        ...
        private ParameterViewModel AddParameter(IElementOwner owner, IVariable variable)
        {
            var parameter = new ParameterViewModel(owner, "value", variable.Type);
