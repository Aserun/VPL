...
{
    public class VariableGetterViewModel : OperatorViewModelBase, IVariableReference
    {
        private readonly IVariable _variable;

        public VariableGetterViewModel(IElementOwner owner, Guid variableId) 
        ...
        public VariableGetterViewModel(IElementCreationContext context) 
